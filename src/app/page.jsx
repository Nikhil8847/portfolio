...
import { Heading, Flex, Center, Image, Tooltip, Link, Text, Icon } from "@chakra-ui/react";
...
export default function Home() {
  ...
  useEffect(() => {
    const options = {
      strings: ["Developer", "Coder", "Tech Enthusiast", "Competitive Programmer"],
      typeSpeed: 50,
      backSpeed: 35,
      loop: true,
    };
        ...
        >
          ...
          <RevealWrapper>
            <Tooltip label="Send Mail">
              <Link
                href="mailto:nikhil.rajput.cs@gmail.com"
                target="_blank"
              ...
              >
                ...
                <Text>nikhil.rajput.cs@gmail.com</Text>
              </Link>
            </Tooltip>
          </RevealWrapper>
